        ...
        <div>
                        ...
                        <h1 className='cart'>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" id="IconChangeColor"
                                ...
                                <text x="50%" y="50%" dominantBaseline="middle" textAnchor="middle" fill="#FFFFFF">
                                    {countItemsInCart() > 0 && countItemsInCart()}
                                </text>
                                <path
            ...
            {!showCart ? (
                <div className="product-grid">
                    ...
                    {plantsArray.map((category, category_index) => (
                            ...
                            <div className="product-list">
                                {category.plants.map((plant, index) => (
                                    <div className="product-card" key={index}>
                                        ...
                                        <button className={(plant.name in addedToCart) ? "product-button added-to-cart"
                                                           : "product-button"}
                                                onClick={() => !(plant.name in addedToCart) && handleAddToCart(plant)}
                                        >{(plant.name in addedToCart) ? 'Added to Cart' : 'Add to Cart'}</button>
                                    </div>
                                ))}
                            </div>
                        </div>
